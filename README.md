...
* Travis CI を設定して、自動ビルドが通るようにしてください
   ...
   * 参考サイト：参考サイト：[Travis CIで自動テストして、結果をGitHubのトップページに表示する](https://qiita.com/hoshimado/items/4090d8e64beb8a7f95e1)
...
[![Build Status](https://travis-ci.org/t-kougei-game-comp-2018/13_rand.svg?branch=master)](https://travis-ci.org/t-kougei-game-comp-2018/13_rand)
